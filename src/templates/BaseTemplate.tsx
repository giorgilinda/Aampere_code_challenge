              ...
              <ul>
                <li>
                  <a href="mailto:giorgi.linda@gmail.com">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-[20px] inline-block mr-[10px]">
                ...
                <li>
                  <a href="https://github.com/giorgilinda" target="_blank" rel="noreferrer noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className="w-[20px] inline-block mr-[10px]">
